...
export const useAuthStore = defineStore('auth', () => {
  ...
  async function signIn(payload: IUserSignIn) {
    ...
    if (signInData.value) profile.value = signInData.value;
  }
  ...
  async function signOut() {
    ...
    if (signOutData.value) profile.value = null;
  }
