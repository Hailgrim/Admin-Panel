...
import type { IFindAndCountRes, IListReq, IResource, IResourceCreate, IUpdateReq } from '~/utils/types'
...
export const useResourcesStore = defineStore('resources', () => {
  ...
  const {
    ...
    execute: list,
    refresh: listRefresh,
  } = useCustomFetch<IResource[], IListReq<IResource> | void>(payload => ({
    url: ROUTES.api.resources,
  ...
  } = useCustomFetch<IFindAndCountRes<IResource>, IListReq<IResource> | void>(payload => ({
    url: ROUTES.api.resources,
